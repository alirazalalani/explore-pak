...
<div class="container" style="margin-top:100px;margin-left:380px">
	<div class="row">
		...
		<div class="col-sm-4">
			...
			<h4 class="text-success" style="width:100%;" ><strong>Checkout Page</strong></h4>
			<form method="post" id="checkoutform" style="position: relative;display:flex;flex-direction:column;justify-content:center;" >
